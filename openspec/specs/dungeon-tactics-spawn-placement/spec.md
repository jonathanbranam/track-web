...
Defines the turn-0 placement phase for Dungeon Tactics Solo: how the match opens with PCs
inside a defended spawn zone derived from the power-center structures, how the player
inspects units and repositions PCs within the zone, how the zone is highlighted, how NPCs
stay inert (but inspectable) during placement, and how "Done" commits positions and starts
