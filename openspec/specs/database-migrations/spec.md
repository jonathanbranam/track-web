...
Documents the database migration tracking system: how schema changes are applied exactly once on startup, how the migration state is captured in exports, and how the import script validates compatibility before restoring data.
