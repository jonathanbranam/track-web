...
The talks directory provides the public landing page at `talks.branam.us` that lists talks as cards linking to per-talk content pages, seeded with the first talk.
