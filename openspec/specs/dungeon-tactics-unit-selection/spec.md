...
Defines the unit-selection and info-popup UX for Dungeon Tactics Solo: how the player selects PC and NPC units during the player phase, how unit info popups present stats and actions, and how walk/attack overlays and action state are driven by selection.
