...
- **Game name**: setup includes a **game-name picker** backed by a remembered list of previously-played game names, plus **free-form text** to name any game not yet in the list. Newly-entered names are added to the remembered list. The list is **seeded** with Sushi Go, Tides of Time, Pit, Farkle, and Uno.
