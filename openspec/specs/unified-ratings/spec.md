...
Unified ratings experience for `client-watch`. Covers the `/ratings` route, combined movie + TV ratings API, `MediaCard` component with inline rating editing, filter bar, add-to event/list integration, and admin CLI support.
