...
Covers cross-subdomain session sharing: wildcard domain cookies so a single login works across all apps, and a shared auth middleware applied to all app-prefixed routes.
