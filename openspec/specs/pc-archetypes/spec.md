...
Defines the PC archetypes in Dungeon Tactics Solo other than melee (which has its own dedicated `melee-archetype` capability). Each archetype has a distinct move range, attack pattern, damage output, and visual color. All PCs start with 3 HP.
