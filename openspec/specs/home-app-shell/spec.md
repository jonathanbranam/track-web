...
The home app shell defines the workspace, build, and deployment wiring for the `home.branam.us` client app — a React 19 + Vite + Tailwind 4 + PWA frontend served from the `client-home` npm workspace.
