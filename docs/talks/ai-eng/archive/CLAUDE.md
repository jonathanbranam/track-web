...
- **`script.md`** — Beat-by-beat map from the original talk outline to RPG
  beats, written against the old forward-only Beat model. Superseded by the
  current action-list model in `../requirements.md` / `../action-vocabulary.md`.
- **`adm-talk-outline.md`** — Original spoken talk outline (vibe
  coding / spec-driven development / harness, generic visuals, no Dragon
  Warrior specifics). Superseded by `../adm-talk-story-board-01.md`'s
  resolved beat-by-beat script and the locked narrative in `../idea-board.md`.
